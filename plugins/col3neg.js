       ...
       // ==============================================================
        ...
        // ==============================================================
            ...
            try {
                ...
                const { data } = await axios.get(storedData.movieUrl, {
                ...
                // ෆිල්ම් එකේ පිටුව ඇතුළේ තියෙන Download ලින්ක්ස් සහ Iframe ලින්ක්ස් හොයනවා
                $('a').each((i, el) => {
                ...
                // සමහරවිට සයිට් එකේ Direct Link නැතුව Iframe එකක් (YouTube වගේ) තියෙන්න පුළුවන්
                $('iframe').each((i, el) => {
        ...
        // ==============================================================
        // 3. AUTO DOWNLOAD (With RAM Saver)
        // ==============================================================
