...
Sparky({
    ...
    try {
        ...
        // 🔥 FIX: Setup Stream to Disk (Prevents Memory Leaks)
        ...
        const fileRes = await axios({
            method: 'GET',
            url: downloadUrl,
            responseType: 'stream', // Request stream instead of arraybuffer
            timeout: 0, 
            headers: { 
        ...
        // Get actual size from downloaded file
        ...
        // Send file to WhatsApp using Stream (Memory efficient)
        await client.sendMessage(m.jid, {
            document: { stream: fs.createReadStream(tempFilePath) }, // Uploads from disk directly
            mimetype: mimetype,
        ...
        // Ensure cleanup even if sending fails
